/**
 * ISO 3166-1 alpha-2 country list used in the Settings → Profile country
 * dropdown. Mirrors the set Polar accepts on its billing-address field
 * (Polar, via Stripe under the hood, supports the full alpha-2 space —
 * see https://polar.sh/docs/api-reference/).
 *
 * EU/EEA members are pinned first so they surface as the common case for
 * invoices + VAT. Everything else follows alphabetically by English name.
 */
...
/**
 * EU/EEA + UK/CH pinned first (common case for invoicing + reverse-charge
