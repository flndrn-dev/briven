...
function AuthMovedNotice({ projectId }: { projectId: string }) {
  return (
    <section className="flex flex-col gap-6 py-4">
      <div className="rounded-md border border-[color-mix(in_srgb,#e6b800_45%,var(--color-border))] bg-[var(--color-surface-raised)] p-6">
        <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#e6b800]">
          Auth moved
        </p>
