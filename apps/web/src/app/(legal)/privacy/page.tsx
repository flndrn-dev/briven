  ...
  return (
    <>
      ...
      <ul className="mt-2 list-disc pl-6">
        ...
        <li>
          <strong>Usage:</strong> request paths and response codes on the API; per-project audit
          log of mutations.
        </li>
      </ul>
      ...
      <ul className="mt-2 list-disc pl-6">
        ...
        <li>The contents of customer database rows — we operate the cluster, we don&rsquo;t read it.</li>
      </ul>

      <h2 className="mt-10 font-mono text-lg text-[var(--color-text)]">retention</h2>
      <p>
        Account and project data persists for as long as your account is active. Deleting a
        project soft-deletes immediately and hard-deletes after 30 days. Audit logs retain for
        13 months, then rotate.
      </p>
      ...
      <p>
        ...
        deletion via the Settings page, or email <em>privacy@briven.cloud</em> for any GDPR
        request (access, rectification, erasure, portability, restriction, objection).
      </p>
