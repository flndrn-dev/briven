...
export default function TermsPage() {
  return (
    <>
      ...
      <p>
        briven is an open-core reactive postgres platform operated by an individual EU developer. By
      ...
      <ul className="mt-2 list-disc pl-6">
        ...
        <li>
          No workloads that use the free / personal tier to serve production for a separate paying
          entity — use a paid tier or self-host.
        </li>
      </ul>

      <h2 className="mt-10 font-mono text-lg text-[var(--color-text)]">phase 0 alpha</h2>
      <p>
        During private alpha we make <strong>no uptime guarantee</strong> and may change, deprecate,
        or remove features with one week&rsquo;s notice. Data is backed up nightly; see the{' '}
      ...
      <p>
        You retain all rights to the data you put on briven. You grant us only the limited licence
        required to operate the service — store, back up, and serve it to clients you authenticate.
      </p>
      ...
      <p>
        ...
        accounts that violate these terms with reasonable notice and a full export opportunity where
        possible.
      </p>
