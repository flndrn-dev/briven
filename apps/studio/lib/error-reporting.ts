...
const WHITELIST_ERRORS = [
  ...
  'Project creation in the Briven dashboard is disabled for this Vercel-managed organization.',
  'Your account, which is handled by the Fly Briven extension, cannot access this endpoint.',
