...
describe('isValidEdgeFunctionURL', () => {
  const validEdgeFunctionUrls = [
    ...
    'https://uniquetwentychararef.briven.red/functions/v1/hello-world',
    'https://uniquetwentychararef.briven.red/functions/v3/hello-world',
    'https://uniquetwentychararef.briven.red/functions/v3/hello-world',
  ]

  const validLocalEdgeFunctionsUrls = [
    'https://projectref.notbriven.com/functions/v1/test',
    'https://notbriven.com/functions/v1/test',
