...
export const AVAILABLE_WEBHOOK_TYPES = [
  ...
  ...(IS_PLATFORM
    ? [
        {
          value: 'briven_function',
          icon: `${BASE_PATH}/img/function-providers/briven-severless-function.png`,
          label: 'Briven Edge Functions',
          description: 'Choose a Briven edge function to run.',
        },
      ]
    : []),
]
