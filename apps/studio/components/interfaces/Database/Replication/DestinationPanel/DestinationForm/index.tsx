...
export const DestinationForm = ({
  ...
  const defaultValues = useMemo(() => {
    ...
    return {
      ...
      warehouseName: isIcebergConfig ? config.iceberg.briven.warehouse_name : '',
      namespace: isIcebergConfig ? config.iceberg.briven.namespace : '',
      newNamespaceName: '',
      catalogToken: isIcebergConfig ? config.iceberg.briven.catalog_token : catalogToken,
      s3AccessKeyId: isIcebergConfig ? config.iceberg.briven.s3_access_key_id : '',
      s3SecretAccessKey: isIcebergConfig ? config.iceberg.briven.s3_secret_access_key : '',
      s3Region:
        projectSettings?.region ?? (isIcebergConfig ? config.iceberg.briven.s3_region : ''),
      // DuckLake fields
