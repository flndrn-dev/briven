          ...
          <div className="space-y-6">
            <div className="space-y-1">
              ...
              <p className="text-sm text-foreground-light">
                Connect a GitHub repository to a Briven project. The GitHub app watches file,
                ...
                {connections?.map((connection) => (
                  <IntegrationConnectionItem
                    ...
                    connection={{
                      ...
                      briven_project_ref: connection.project.ref,
            ...
            {isGitHubAuthorized && (
              <p className="text-sm text-foreground-light">
                You are authorized with the Briven GitHub App. You can configure your{' '}
