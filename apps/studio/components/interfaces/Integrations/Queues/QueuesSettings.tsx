                        ...
                        description={
                          <>
                            <p className="max-w-2xl">
                              ...
                              manage your queues via any Briven client library or PostgREST
                              endpoints:
                            </p>
                            <p className="mt-2">
                            ...
                            {!IS_PLATFORM ? (
                              <div className="mt-6 max-w-2xl">
                                When running Briven locally with the CLI or self-hosting using
                      ...
                      {formState.dirtyFields.enable && field.value === true && (
                        <Admonition type="warning" className="mt-2">
                          ...
                          <p className="text-foreground-light">
                            ...
                            enabling. Call these functions via any Briven client library or
