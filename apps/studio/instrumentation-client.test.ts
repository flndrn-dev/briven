...
describe('Sentry beforeSend filtering functions', () => {
  ...
  describe('integration scenarios', () => {
    it('correctly identifies BRIVEN-APP-353 pattern (cancellation rejection)', () => {
      // Based on actual Sentry issue BRIVEN-APP-353
      const event: SentryEvent = {
        exception: {
          values: [
            {
    ...
    it('correctly identifies BRIVEN-APP-AFC pattern (wallet extension)', () => {
      // Based on actual Sentry issue BRIVEN-APP-AFC
      const event: SentryEvent = {
        exception: {
          values: [
            {
    ...
    it('correctly identifies BRIVEN-APP-92A pattern (wallet extension)', () => {
      // Based on actual Sentry issue BRIVEN-APP-92A
      const event: SentryEvent = {
        exception: {
          values: [
            {
    ...
    it('correctly identifies BRIVEN-APP-BG6 pattern (user aborted)', () => {
      // Based on actual Sentry issue BRIVEN-APP-BG6
      const error = new Error('The operation was aborted.')
      const event: SentryEvent = {
        message: '[CRITICAL][sign in via EP] Failed: The operation was aborted.',
      }
    ...
    it('correctly identifies BRIVEN-APP-BG7 pattern (signal aborted)', () => {
      // Based on actual Sentry issue BRIVEN-APP-BG7
      const error = new Error('signal is aborted without reason')
      const event: SentryEvent = {
        message: '[CRITICAL][sign in via EP] Failed: signal is aborted without reason',
      }
    ...
    it('correctly identifies BRIVEN-APP-ACC pattern (challenge expired)', () => {
      // Based on actual Sentry issue BRIVEN-APP-ACC
      const error = new Error('Non-Error promise rejection captured with value: challenge-expired')
      const event: SentryEvent = {
        exception: {
          values: [
